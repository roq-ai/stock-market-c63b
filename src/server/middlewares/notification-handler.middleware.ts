...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'stock.update': {
    roles: ['system-owner', 'data-analyst', 'software-developer'],
    key: 'stock-data-updated',
    tenantPath: ['organization', 'stock'],
    userPath: [],
  },
  'algorithm.create': {
    roles: ['system-owner', 'software-developer'],
  ...
  'stock.delete': {
    roles: ['system-owner', 'data-analyst', 'software-developer'],
    key: 'stock-data-deleted',
    tenantPath: ['organization', 'stock'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['system-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['system-owner', 'data-analyst', 'software-developer'];
