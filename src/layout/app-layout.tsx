...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-owner', 'data-analyst', 'software-developer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Algorithms', path: '/algorithms', entity: 'algorithm', service: AccessServiceEnum.PROJECT, icon: FiCpu },
    {
      name: 'Data Analyses',
      path: '/data-analyses',
    ...
    { name: 'Stocks', path: '/stocks', entity: 'stock', service: AccessServiceEnum.PROJECT, icon: FiBarChart2 },
