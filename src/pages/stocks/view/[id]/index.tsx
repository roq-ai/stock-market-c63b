...
import { DataAnalysisListPage } from 'pages/data-analyses';
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Open Price" text={data?.open_price} />

                <FormListItem label="Close Price" text={data?.close_price} />

                <FormListItem label="High" text={data?.high} />

                <FormListItem label="Low" text={data?.low} />
