...
export function StockListPage(props: StockListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStocks({
        relations: ['organization', 'data_analysis.count'],
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'open_price', header: 'Open Price', accessorKey: 'open_price' },
    { id: 'close_price', header: 'Close Price', accessorKey: 'close_price' },
    { id: 'high', header: 'High', accessorKey: 'high' },
    { id: 'low', header: 'Low', accessorKey: 'low' },
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('data_analysis', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'data_analysis',
          header: 'Data Analysis',
          accessorKey: 'data_analysis',
          cell: ({ row: { original: record } }: any) => record?._count?.data_analysis,
        }
      : null,
