...
import { getDataAnalysisById } from 'apiSdk/data-analyses';
import { DataAnalysisInterface } from 'interfaces/data-analysis';

function DataAnalysisViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('data_analysis', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/data-analyses/edit/${id}`} passHref legacyBehavior>
                    <Button
