...
import { createDataAnalysis } from 'apiSdk/data-analyses';
...
function DataAnalysisCreatePage() {
  ...
  const handleSubmit = async (values: DataAnalysisInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createDataAnalysis(values);
      resetForm();
