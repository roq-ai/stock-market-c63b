...
import { getDataAnalyses } from 'apiSdk/data-analyses';
...
import { DataAnalysisListPage as ShowCaseList } from 'pages/data-analyses';
...
function DashboardPage() {
  ...
  const dataAnalysisStat = useSWR<PaginatedInterface<DataAnalysisInterface>>(
    () => `/data-analyses`,
    () => getDataAnalyses({ limit: 1, offset: 0 }),
  );
  ...
  const statResults: { title: string; result: number; change: number; isLoading: boolean }[] = [
    ...
    {
      title: 'Data Analyses',
      result: dataAnalysisStat?.data?.totalCount,
      isLoading: dataAnalysisStat.isLoading,
      change: Math.floor(Math.random() * (100 - 40 + 1) + 40),
    },
    {
      title: 'Algorithms',
            ...
            <Box>
              <Flex mb={4} justifyContent={'space-between'}>
                <Text as="b" fontSize="xl">
                  Latest Data Analyses
                </Text>
                <NextLink href={`data-analyses`} passHref legacyBehavior>
                  <Button
